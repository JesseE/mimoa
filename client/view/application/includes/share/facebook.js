 ...
 */
Template.shareit__facebook.rendered = function() {
    if (!this.data) {
        return;
    }
    this.autorun(function() {
        ...
        //} else {
            ...
            href = base + "?s=100&p[url]=" + url + "&p[title]=" + title + "&p[summary]=" + summary + "&p[images][0]=" + img;
            //if (img) {
...
Template.shareit__facebook.helpers();